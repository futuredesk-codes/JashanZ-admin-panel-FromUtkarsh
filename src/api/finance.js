...
export const getFinancePayouts = (params) => api.get('/finance/settlements', params)
export const getFinanceCommissions = (params) => api.get('/finance/commissions', params)
export const getFinanceCommissionRates = () => api.get('/finance/commission-rates')
export const setFinanceGlobalCommissionRate = (rate) => api.post('/finance/commission-rate/global', { rate })
export const setFinanceVendorCommissionRate = (businessId, rate) =>
  api.post(`/finance/commission-rate/vendor/${businessId}`, { rate })
export const getRefundablePayments = (params) => api.get('/finance/refunds/payments', params)
export const getRefunds = (params) => api.get('/finance/refunds', params)
export const initiateRefund = (payload) => api.post('/finance/refunds', payload)
