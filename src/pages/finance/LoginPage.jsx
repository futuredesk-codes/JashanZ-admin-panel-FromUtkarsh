    ...
    <div className="min-h-screen flex bg-[#0f172a]">
      <div className="hidden lg:flex w-[42%] shrink-0 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 bg-warning/15 border border-warning/25 text-warning text-xs font-semibold px-3 py-1.5 rounded-full mb-6">
            <span className="w-1.5 h-1.5 bg-warning rounded-full" />
            Finance Portal
          </div>
          <h2 className="text-white text-4xl font-black leading-tight mb-4">
            Finance<br /><span className="text-warning">Team Access</span>
          </h2>
          <p className="text-white/50 text-sm leading-relaxed max-w-xs">
            Secure access for the Jashanz finance team to manage settlements, refunds, and commission configuration.
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white rounded-l-3xl">
        <div className="w-full max-w-sm">
          <h2 className="text-2xl font-black text-slate-800 mb-1">Finance Login</h2>
          <p className="text-slate-500 text-sm mb-8">Access the finance portal</p>
