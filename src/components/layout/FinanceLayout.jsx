...
const NAV = [
  ...
  { id: 'booking-payments', pageId: 'financeBookingPayments', label: 'Booking Payments', path: '/finance/booking-payments', icon: () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg> },
...
const TITLES = {
  ...
  '/finance/booking-payments': 'Booking Payments',
